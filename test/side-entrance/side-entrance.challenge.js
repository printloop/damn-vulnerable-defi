...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
      const AttackFactory = await ethers.getContractFactory('AttackSideEntranceLenderPool', attacker);
      attack = await AttackFactory.deploy(this.pool.address);
      await attack.attack(ETHER_IN_POOL);
    });
